...
createForm: FormGroup;
  ...
  inputValid(inputName: 'name' | 'description' | 'beginDate' | 'endDate') {
    return this.createForm.get(inputName)?.valid && this.createForm.get(inputName)?.touched;
  }

  inputInvalid(inputName: 'name' | 'description' | 'beginDate' | 'endDate') {
    return (
  ...
  getError(inputName: 'name' | 'description' | 'beginDate' | 'endDate') {
